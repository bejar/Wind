...
def architectureS2STForce(ahead, idimensions, odimensions, neurons, neuronsD, drop, nlayersE, nlayersD, activation, activation_r, rnntype, impl=1):
    """
...
def architectureS2STForce2(ahead, idimensions, neurons, neuronsD, drop, nlayersE, nlayersD, activation, activation_r, rnntype, impl=1,
                    CuDNN=False,
                    bidirectional=False,
...
def train_seq2seq_tforce__architecture(config, impl, verbose, tboard, best, early):
    ...
    model = architectureS2STForce(ahead=ahead, idimensions=train_x.shape[1:], neurons=neurons,
