...
:Description: CNNS2SArchitecture
    ...
    Class for convolutional sequence to sequence architecture with separate inputs for target and near sites
...
class CNNS2SSeparateArchitecture(NNS2SArchitecture):
    """
